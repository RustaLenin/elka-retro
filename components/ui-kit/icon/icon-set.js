export const icons = {
    search: `
      <svg viewBox="0 0 24 24" fill="none">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.0392 15.6244C18.2714 14.084 19.0082 12.1301 19.0082 10.0041C19.0082 5.03127 14.9769 1 10.0041 1C5.03127 1 1 5.03127 1 10.0041C1 14.9769 5.03127 19.0082 10.0041 19.0082C12.1301 19.0082 14.084 18.2714 15.6244 17.0392L21.2921 22.707C21.6828 23.0977 22.3163 23.0977 22.707 22.707C23.0977 22.3163 23.0977 21.6828 22.707 21.2921L17.0392 15.6244ZM10.0041 17.0173C6.1308 17.0173 2.99087 13.8774 2.99087 10.0041C2.99087 6.1308 6.1308 2.99087 10.0041 2.99087C13.8774 2.99087 17.0173 6.1308 17.0173 10.0041C17.0173 13.8774 13.8774 17.0173 10.0041 17.0173Z"></path>
      </svg>
    `,
    moon: `
      <svg viewBox="0 0 24 24" fill="none">
    ...
    sun: `
      <svg viewBox="0 0 24 24" fill="none">
        <path d="M7.28451 10.3333C7.10026 10.8546 7 11.4156 7 12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7C11.4156 7 10.8546 7.10026 10.3333 7.28451"></path> 
        <path d="M12 2V4"></path> 
        <path d="M12 20V22"></path> 
        <path d="M4 12L2 12"></path> 
        <path d="M22 12L20 12"></path> 
        <path d="M19.7778 4.22266L17.5558 6.25424"></path> 
        <path d="M4.22217 4.22266L6.44418 6.25424"></path> 
        <path d="M6.44434 17.5557L4.22211 19.7779"></path> 
        <path d="M19.7778 19.7773L17.5558 17.5551"></path>
      </svg>
    `,
    about: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <rect x="3" y="3" width="18" height="18" rx="2" ry="2" fill="none"/>
        <line x1="9" y1="3" x2="9" y2="21" fill="none"/>
      </svg>
    `,
    contact: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <rect x="3" y="3" width="18" height="18" rx="2" ry="2" fill="none"/>
        <line x1="15" y1="3" x2="15" y2="21" fill="none"/>
      </svg>
    `,
    logo: `
    ...
    cart: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" fill="none"/>
      </svg>
    `,
    menu: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <line x1="3" y1="18" x2="21" y2="18" fill="none"/>
      </svg>
    `,
    facebook: `
    ...
    instagram: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" fill="none"/>
      </svg>
    `,
    twitter: `
      <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    chevron_left: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <polyline points="15 18 9 12 15 6" fill="none"/>
      </svg>
    `,
    chevron_right: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <polyline points="9 18 15 12 9 6" fill="none"/>
      </svg>
    `,
    chevron_down: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    news: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2" fill="none"/>
        <path d="M18 14h-8" fill="none"/>
        <path d="M15 18h-5" fill="none"/>
        <path d="M10 6h8v4h-8V6Z" fill="none"/>
      </svg>
    `,
    gift: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <line x1="12" y1="22" x2="12" y2="7" fill="none"/>
    ...
    fire: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" fill="none"/>
      </svg>
    `,
    check: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    alert_triangle: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" fill="none"/>
    ...
    alert_circle: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <line x1="12" y1="8" x2="12" y2="12" fill="none"/>
        <line x1="12" y1="16" x2="12.01" y2="16" fill="none"/>
      </svg>
    `,
    question: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    x_circle: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="12" cy="12" r="10" fill="none"/>
        <line x1="15" y1="9" x2="9" y2="15" fill="none"/>
    ...
    'eye-off': `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" fill="none"/>
