<?php
/**
 * Template part: Latest NY Accessories preview on homepage
 *
 * @package ElkaRetro
 */
...
if ($ny_accessories_query->have_posts()) :
    echo '<div class="ny-accessories-section-wrapper">';

    echo '<div class="ny-accessories-section-header">';
    echo '<div class="ny-accessories-section-title-group">';
    echo '<div class="ny-accessories-section-title-icon"><ui-icon name="sparkles" size="small"></ui-icon></div>';
    echo '<h2 class="ny-accessories-section-title">Новогодние аксессуары</h2>';
    echo '</div>';
    echo '</div>';
    ...
    echo '</div>'; // .ny-accessories-section-wrapper
endif;
